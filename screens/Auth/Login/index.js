...
import { signupRequest, loginSuccess, loginFailure, signupFailure } from './actions';
              ...
              <KeyboardAvoidingView contentContainerStyle={styles.loginContainer} behavior='position'>
                <View style={styles.titleContainer}>
                  <View style={{flexDirection: 'row'}}>
                    <Text style={styles.titleText}>TOUTES MES</Text>
                  </View>
                  <View style={{marginTop: -10, marginLeft: 10}}>
                    <Text style={styles.titleText}>ORDONNANCES</Text>
                  </View>
                </View>
                <View style={{flexDirection: 'row'}}>
                  <Button
